...
const HeroSection = () => {
  ...
  return (
    ...
    bg-cover bg-center h-screen'>
        ...
        <p className='max-w-md text-gray-300'>In a post-apocalyst world where cities ride on
          wheels and consume each other to survive, two people
          meet in London and try to stop a conspiracy.
        </p>
        <button onClick={()=> navigate('/movies')} className='flex items-center gap-1 px-6 py-3
        text-5m bg-primary hover:bg-primary-dull transition rounded-full 
        font-medium cursor-pointer'>Explore Movies
